...
public class CommandDisplayCollar extends CommandKidnapMod {
   public String func_71517_b() {
      return "displaycollar";
   }

   public String func_71518_a(ICommandSender sender) {
      return "command.displaycollar";
   }
   ...
   public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] params) throws CommandException {
      if (sender instanceof EntityPlayer) {
         ...
         if (player != null) {
            ...
            if (cap != null) {
               if (cap.displayCollar) {
                  cap.setDisplayCollar(false);
                  Utils.sendValidMessageToEntity(player, "Collar displaying disabled");
               } else {
                  cap.setDisplayCollar(true);
                  Utils.sendValidMessageToEntity(player, "Collar displaying enabled");
               }
