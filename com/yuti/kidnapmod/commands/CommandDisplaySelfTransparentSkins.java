...
public class CommandDisplaySelfTransparentSkins extends CommandKidnapMod {
   public String func_71517_b() {
      return "displayselftransparentskin";
   }

   public String func_71518_a(ICommandSender sender) {
      return "command.displayselftransparentskin";
   }
   ...
   public void func_184881_a(MinecraftServer server, ICommandSender sender, String[] params) throws CommandException {
      if (sender instanceof EntityPlayer) {
         ...
         if (player != null) {
            ...
            if (cap != null) {
               if (cap.allowTransparentSkin) {
                  cap.setAllowTransparentSkin(false);
                  Utils.sendValidMessageToEntity(player, "Transparent skins (on you) disabled");
               } else {
                  cap.setAllowTransparentSkin(true);
                  Utils.sendValidMessageToEntity(player, "Transparent skins (on you) enabled");
               }
