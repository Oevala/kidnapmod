...
public class ItemStraitJacket extends ItemBind {
   public ItemStraitJacket(String name, ExtraBondageMaterial materialIn, int resistance, int mergePercent) {
   ...
   public ModelBiped getBondageModel(EntityLivingBase entity, ItemStack stack, ExtraBondageItemType slot, ModelBiped modelBase) {
      return ModelsUtils.RESTRAINT_STRAITJACKET;
   }

   @SideOnly(Side.CLIENT)
   public TiedUpRenderPlayer getTiedUpPlayerRenderer() {
      return RenderUtilsPlayer.playertiedUprenderStraitJacket;
   }

   @SideOnly(Side.CLIENT)
   public TiedUpRenderDamsel getTiedUpDamselRenderer() {
      return RenderUtilsDamsel.damselTiedUprenderStraitJacket;
   }
}
