...
public class ItemBlindfoldColored extends ItemBlindfold implements IHasColorVariants {
   private EnumDyeColor mainColor;
   protected int countItem = 16;

   public ItemBlindfoldColored(String name, ExtraBondageMaterial materialIn, EnumDyeColor mainColorIn) {
