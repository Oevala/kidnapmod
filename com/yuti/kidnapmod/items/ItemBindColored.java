...
public class ItemBindColored extends ItemBind implements IHasColorVariants {
   private EnumDyeColor mainColor;
   protected int countItem = 16;

   public ItemBindColored(String name, ExtraBondageMaterial materialIn, int resistance, int mergePercent, EnumDyeColor mainColorIn) {
