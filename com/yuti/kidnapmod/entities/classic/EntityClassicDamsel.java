...
public class EntityClassicDamsel extends EntityDamsel {
   private static final DataParameter<Integer> SKIN_NUMBER;

   public EntityClassicDamsel(World world) {
      super(world);
   }

   protected void func_70088_a() {
      super.func_70088_a();
      EntitiesClassicDamsels randomDamsel = EntitiesClassicDamsels.getRandomDamsel();
      this.field_70180_af.func_187214_a(SKIN_NUMBER, randomDamsel.getId());
      this.field_70180_af.func_187214_a(SMALL_ARMS, randomDamsel.hasSmallArms());
   ...
   public ResourceLocation getSkin() {
      return new ResourceLocation("knapm", "textures/entity/damsel/dam_mob_" + this.getSkinNumber() + ".png");
   }

   static {
      SKIN_NUMBER = EntityDataManager.func_187226_a(EntityClassicDamsel.class, DataSerializers.field_187192_b);
   }
}
