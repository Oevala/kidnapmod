package com.yuti.kidnapmod.models.render.enclosed;

import net.minecraft.client.model.ModelPlayer;
import net.minecraft.client.renderer.GlStateManager;
import net.minecraft.entity.Entity;

public class ModelTiedUpEnclosed extends ModelPlayer {
   public ModelTiedUpEnclosed(float modelSize, boolean smallArmsIn) {
