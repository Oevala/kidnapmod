...
public class GuiUntyingOverlay extends GuiTimedState {
   public final ResourceLocation ressource = new ResourceLocation("knapm", "textures/gui/untyingbar.png");

   protected PlayerStateTask getTask(PlayerBindState state) {
      return state.getClientUntyingTask();
   }
